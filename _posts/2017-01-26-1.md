...
在Retext下想使用数学公式，首先应该先安装MathJax，同时需要在在Markdown extensions框里添加字段：mathjax
...
打开**编辑**->**个人偏好**设置详细如下图所示：

![Retext配置截图](/image/2017-01-26-1-1.png)
